const IntroPanel = ({height}) =>{
    return(
        <div id='row' className="col-12 pt-4 d-flex flex-column  align-items-center justify-content-center" style={{minHeight:height,height:'max-content'}}>
